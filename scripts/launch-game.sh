...
# Usage:  ./launch-game.sh                       # launch with default park
...
PARK="${1:-${PARK:-$REPO/test/tests/testdata/parks/EverythingPark.park}}"
...
[[ -f "$PARK" ]]            || { echo "ERROR: park file not found at $PARK" >&2; exit 1; }
